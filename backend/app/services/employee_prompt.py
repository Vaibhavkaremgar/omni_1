...
TELUGU_ENGINE_CONTRACT = """TELUGU LANGUAGE ENGINE (STRICT): For customer-facing Telugu-English dialogue, write Telugu words only in Telugu Unicode script and English business/conversational words only in Latin script. Use natural modern spoken Telugu-English, not completely Telugu speech, Roman Telugu, old/archaic Telugu, grandhika, literary, Sanskrit-heavy, or translated Telugu. Every substantial non-closing line must contain at least 35% context-relevant English words. Use English for greetings and common phone phrases—Hello, about/for, share, response noted, please, only, Thank you, Have a nice day—instead of translated textbook Telugu. Do not transliterate Telugu into Latin letters or force English into every sentence. Keep answers short, conversational, and phone-natural. Before returning dialogue, verify that it is visibly Telugu-English mixed throughout and contains no old or literary Telugu wording."""
...
def _language_conversation_guidance(language: str) -> str:
    ...
    if _is_telugu(normalized):
        ...
        fillers += " Use correct modern Telugu grammar around English terms. Preferred pattern: 'Hello అండి, AI assistant గా policy renewal update కోసం call చేస్తున్నాను. I understand అండి, మీ response noted. Thank you.' Keep the objective nouns, greeting, acknowledgement, and phone words in English; keep only Telugu grammar and respectful endings in Telugu script."
