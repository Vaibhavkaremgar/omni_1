...
class RealLLMService(LLMService):
    ...
    def generate_call_script(self, employee: AIEmployee, configuration: dict[str, Any]) -> dict[str, str]:
        ...
        if str(context["language"]).casefold() in {"hindi", "hi", "hi-in", "hindi (india)"}:
            system += (
                "\n\nHINDI HINGLISH CONTRACT: Keep internal instructions in English, but every customer-facing Hindi spoken example must be natural Indian Hinglish: Hindi grammar with frequent English words and connectors embedded in the same sentence. Hindi words must be written in Devanagari, never Roman Hindi. Do not generate pure, formal, literary, Sanskritized, or textbook Hindi. Use examples such as 'Okay \u091c\u0940, \u0906\u092a\u0915\u0940 requirement \u0938\u092e\u091d \u0917\u092f\u093e.', 'Actually, \u0907\u0938 location \u092e\u0947\u0902 options available \u0939\u0948\u0902.', 'Sure \u091c\u0940, \u092e\u0948\u0902 details check \u0915\u0930\u0924\u093e \u0939\u0942\u0901.', 'Sorry \u091c\u0940, \u092f\u0947 information available \u0928\u0939\u0940\u0902 \u0939\u0948.', and '\u0906\u092a\u0915\u093e budget \u0915\u093f\u0938 range \u092e\u0947\u0902 \u0939\u0948?'. Use Hindi as the base language, not mostly English."
            )
        if str(context["language"]).casefold() in {"telugu", "te", "te-in", "telugu (india)"}:
            system += (
                "\n\nTELUGU TELUGISH CONTRACT: Keep internal instructions in English, but every customer-facing Telugu spoken example must be natural Telugish: Telugu grammar with common English business words embedded in the same sentence. Telugu words must be written in Telugu script, never Roman Telugu. Use examples such as '\u0c28\u0c2e\u0c38\u0c4d\u0c15\u0c3e\u0c30\u0c02 \u0c05\u0c02\u0c21\u0c3f, \u0c2e\u0c40 insurance renewal \u0c17\u0c41\u0c30\u0c3f\u0c02\u0c1a\u0c3f call \u0c1a\u0c47\u0c36\u0c3e\u0c28\u0c41.', 'Okay \u0c05\u0c02\u0c21\u0c3f, \u0c2e\u0c40 details note \u0c1a\u0c47\u0c38\u0c41\u0c15\u0c41\u0c28\u0c4d\u0c28\u0c3e\u0c28\u0c41.', and 'Sorry \u0c05\u0c02\u0c21\u0c3f, \u0c06 information available \u0c32\u0c47\u0c26\u0c41.'. Use Telugu as the base language, not mostly English."
            )
