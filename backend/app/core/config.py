...
class Settings(BaseSettings):
    ...
    groq_script_model: str | None = Field(default="openai/gpt-oss-120b", validation_alias="GROQ_SCRIPT_MODEL")
    ...
    gemini_script_model: str = Field(default="gemini-3-flash-preview", validation_alias="GEMINI_SCRIPT_MODEL")
